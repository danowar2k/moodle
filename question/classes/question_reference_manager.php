    ...
    public static function convert_legacy_set_reference_filter_condition(array $filtercondition): array {
        ...
        if (!isset($filtercondition['filter'])) {
            ...
            if (isset($filtercondition['tags'])) {
                ...
                static $questiontagcollectionid = 0;
                if (!$questiontagcollectionid) {
                    $questiontagcollectionid = \core_tag_area::get_collection('core_question', 'question');
                }
                $newtags = \core_tag_tag::create_if_missing($questiontagcollectionid, $oldtags);
